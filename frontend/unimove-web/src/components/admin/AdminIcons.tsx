...
const s = (size = 18) => ({ width: size, height: size, display: 'inline-block', flexShrink: 0 });
...
export const IconCar = ({ size = 18 }: IconProps) => (
  <svg style={s(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconScooter = ({ size = 18 }: IconProps) => (
  <svg style={s(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="5" cy="17" r="3"/><circle cx="19" cy="17" r="3"/>
    <path d="M5 17h14"/><path d="M12 17V7l4 2"/><path d="M9 7h3"/>
  </svg>
);
...
export const IconPower = ({ size = 18 }: IconProps) => (
  <svg style={s(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconWarn = ({ size = 18 }: IconProps) => (
  <svg style={s(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
